...
public class PostRideService {
	...
	public void postRide(RideInput rdI, String userId)
	{
		...
		//fromArr = findLatLong(rdI.getStartLoc());
		//toArr = findLatLong(rdI.getEndLoc());
		...
		pstRdDAO.postRide(rdI, fromArr, toArr, userId);
	}
